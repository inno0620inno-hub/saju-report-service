...
효과음과 BGM은 항상 사용자의 다운로드 폴더에 있다. 별도 요청 없이 자동으로 사용한다.

### 로컬 환경 (Windows CLI)
```
효과음1: C:\Users\hyeji\Downloads\_.wav
효과음2: C:\Users\hyeji\Downloads\____.wav
효과음3: C:\Users\hyeji\Downloads\______.wav
BGM:     C:\Users\hyeji\Downloads\A_Long_Cold_Sting_-_Riot.mp3
폰트:    C:\Users\hyeji\Downloads\Cafe24Danjunghae-v2.0.ttf (또는 zip 안에)
```
